...
// stake tokens, unstake tokens, issue token rewards, add allowed tokens, get ETH value
...
contract TokenFarm is Ownable {
    // mappoing - token address -> staker address -> amount
        ...
        returns (uint256)
    {
        ...
        // need to get price of token, and multipply that times the amount of topkens staked
    ...
    {
        // price feed address
        // mapp each token to each of their price feed addresses
